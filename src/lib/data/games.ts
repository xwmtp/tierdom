export const games = [{
    ...
    "hasArt": true,
    "description": "Love everything about this. The storytelling is eerie and unique. Then there is the innovative with the 72-hour loop system, a very bold move by the devs that had the impossible task of making a sequal to OoT. It turned out perfect. The soundtrack includes my all-time favorites. The image of the moon haunts me to this day.",
    ...
    "hasArt": true,
    "description": "An absolute classic, a blueprint for numerous games coming after it. There's not a single game that had more impact on my life; I've replayed it numerous times while growing up, it taught me English, and I even met my partner through the OoT speedrunning community. I just give its successor a slightly higher score for being more original.",
    ...
    "title": "Celeste",
    "hasArt": true,
    "description": "I'm generally not a huge platformer fan, but this game is so insanely good and I loved every moment of it. At points it was so challenging it almost drove me crazy, but I never lost motivation. I even collected all the strawberries! The soundtrack is one of my favorites of all time, and the story hit home.",
    "code": "celeste"
}, {
    "tierLevel": "S",
    "rating": 97,
    ...
    "title": "Hades",
    "hasArt": true,
    "description": "For a long time I was hesitant to buy this, but I'm so glad I did, because it 100% lived up to the hype. I had to work really really hard to finish it, and it was worth every hour. Did not know rogue-like could be this fun, and I'm still impressed by the seemingly never-ending amount of unique dialogue.",
    "code": "hades"
}, {
    "tierLevel": "S",
    "rating": 94,
    ...
    "hasArt": true,
    "description": "Probably my favorite kart game of all time. It's just very charming. The music and sound effects are so quirky and catchy, and I loved the overworld which you usually don't have in these kind of games. Great memories.",
    ...
    "title": "Yoshi's Story",
    "hasArt": true,
    "description": "Cute but difficult game. I love yoshi, and this one might be my favorite. It has an original concept where you play through the whole story in (usually) one sitting, and pick your levels. The better you do, the more choice you have. Hearing the yoshi choir sing still brings a tear to my eye.",
    "code": "yoshis-story"
}, {
    "tierLevel": "A",
    "rating": 90,
    ...
    "title": "Valheim",
    "hasArt": true,
    "description": "The best multiplayer experience I've had in many years. The retro style graphics combined with modern lighting look absolutely gorgeous, and the soundtrack only adds to the scenic experience. The game can be absolutely brutal though, in a good way. The only downside is that it gets a bit repetitive towards the end.",
    "code": "valheim"
}, {
    "tierLevel": "A",
    "rating": 89,
    ...
    "title": "Simcity 4",
    "hasArt": true,
    "description": "The one and only city builder for me. I've spent hours and hours trying to get my cities to grow. At some point the algorithms really start to work against you though, and it seems impossible to progress. The impeccable urban jazzy soundtrack makes up for it.",
    "code": "simcity-4"
}, {
    "tierLevel": "A",
    "rating": 87,
    ...
    "title": "Pilotwings 64",
    "hasArt": true,
    "description": "Had very fond memories of this game, and replayed it all recently when I was ill. Surprisingly, this old game lived up to what I remembered of it! The controls are simple, but the tasks are challenging. It's a very relaxing game, which is partly due to it's great soundtrack.",
    "code": "pilotwings-64"
}, {
    "tierLevel": "B",
    "rating": 87,
    ...
    "title": "Paper Mario",
    "hasArt": true,
    "description": "Probably my first RPG style game! Don't remember all the details, but I have a few vivid memories of a desert world and a ghostly area, among morre. Good game with a cute artstyle.",
    "code": "paper-mario"
}, {
    "tierLevel": "B",
    "rating": 84,
    ...
    "title": "Pok\u00e9mon Snap",
    "hasArt": true,
    "description": "The concept of this game is original, and a lot more fun than it sounds. I enjoyed redoing the levels over and over to find secrets and improve my photo scores. The gameplay is a bit simple, but the game is short enough to not start to drag.",
    "code": "pokemon-snap"
}, {
    "tierLevel": "C",
    "rating": 82,
    ...
    "hasArt": true,
    "description": "Made me fall in love with smash bros again, at least for a while. The movement feels fluid, and the giant character roster makes for a lot of hours of fun.",
    ...
    "hasArt": true,
    "description": "Charming and cute, but not as relaxing as people make it sound, when you have to keep track of which fish to catch and which seeds to plant in which season.",
    "code": "stardew-valley"
}, {
    "tierLevel": "B",
    "rating": 80,
    ...
    "hasArt": true,
    "description": "My feelings on this are very mixed. I think it's a worthy DLC to a perfect base game, but the horror themes were so strong I nearly gave up countless of times. A few alterations would have made the experience a lot less painful for me, but I'm very happy and frankly quite proud I managed to finish it. ",
    ...
    "hasArt": true,
    "description": "This remake is fine, it's just quite similar to the original that came out... one console before. With the expansion pack, the amount of tracks to choose from feels endless though.",
    "code": "mario-kart-8dx"
}, {
    "tierLevel": "C",
    "rating": 79,
    ...
    "title": "Wave Race",
    "hasArt": true,
    "description": "Fun and quite challenging jetski race game. The graphics were stunning at the time and the voice of the announcer is quite iconic. The controls are difficult to master, especially on the wavy tracks, but it feels rewarding when you manage to.",
    "code": "wave-race"
}, {
    "tierLevel": "B",
    "rating": 78,
    ...
    "title": "Stray",
    "hasArt": true,
    "description": "Such a charming little game, with a good story. The game manages to really make you feel like you're observing the world through the eyes of a cat, which is a refreshing way of playing.",
    "code": "stray"
}, {
    "tierLevel": "B",
    "rating": 78,
    ...
    "hasArt": true,
    "description": "My least favorite 3D Zelda, but it's a still a decent game. It drags too much at the start and there's too much handholding, but once you get to the better dungeons it finally gets good. There are a lot of things I would've liked to see differently, but would still recommend the overall experience.",
    ...
    "hasArt": true,
    "description": "Almost exclusively played the party games, usually with my friends from school. These mini games were way more fun than you'd expect from such a game.",
    ...
    "title": "Mario Kart 64",
    "hasArt": true,
    "description": "I was so young when I started playing this, that I started crying everytime I missed the tunnel in Luigi Raceway. Fond memories, but not the kart game I come back to now.",
    "code": "mario-kart-64"
}, {
    "tierLevel": "C",
    "rating": 75,
    ...
    "hasArt": true,
    "description": "More fun mini games! I prefer the 'vibes' of the first game, but that might also be caused by my strong preference of gen 1 Pok\u00e9mon.",
    ...
    "hasArt": true,
    "description": "Quite a strange looking snowboard game looking back now. I've spent countless of after-school afternoons trying to unlock everything there was in this game, and I might be tiering it through nostalgia glasses.",
    "code": "snowboard-kids"
}, {
    "tierLevel": "C",
    "rating": 72,
    ...
    "hasArt": true,
    "description": "No thoughts, head empty, cruising Europe. Poured more hours into this than I'd dare to admit. Just wish connecting a controller wasn't such a shitshow.",
    ...
    "title": "Cruis'n World",
    "hasArt": true,
    "description": "Loved playing this with my dad back in the day, exploring all the tracks set in different countries in the world. But since racing games are not really my favorites, it's average tier.",
    "code": "cruisn-world"
}, {
    "tierLevel": "D",
    "rating": 70,
    ...
    "title": "Mario Golf",
    "hasArt": true,
    "description": "Was probably a fine game in the genre, but not very memorable for me. I've watched my dad play it a lot though, and that taught me most of what I know of golf now.",
    "code": "mario-golf"
}, {
    "tierLevel": "D",
    "rating": 63,
    ...
    "hasArt": true,
    "description": "Played through this game as a child, and remember liking it a lot. Tried to replay it on the Switch recently but it didn't grab me at all. Probably didn't age as well as some other N64 games.",
    ...
    "hasArt": true,
    "description": "Costing full price, this game only includes five different maps, which are all remakes of earlier games. Shame, because with just a few more the replay value would have been a lot higher.",
    ...
    "hasArt": true,
    "description": "Candy crush-like puzzle game. The concept was not as overdone then as it is now, and I think it's a decent game. I enjoyed trying to create my own puzzles when I was a kid. Kind of a low score because there are so many of these kinds of games.",
    ...
    "title": "Mario Party",
    "hasArt": true,
    "description": "Don't remember much from back in the day, but replayed it recently on the Switch and oh my, this is definitely the worst MP I've played. It's the OG and it's still very unbalanced and arbitrary. Had a bit of fun playing it ironically with friends though.",
    "code": "mario-party"
}, {
    "tierLevel": "C",
    "rating": 45,
    ...
    "hasArt": true,
    "description": "It's a bit buggy and messy, and I wish it had a bigger variety of modes. Still, playing quiz games with friends and family always makes for a good time.",
